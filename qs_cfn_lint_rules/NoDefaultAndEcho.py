...
@inherit_doc_string
class PinpointAPNSVoipSandboxChannelNoEcho(ParameterNoEchoDefault, CloudFormationLintRule):
...
@inherit_doc_string
class KinesisFirehoseDeliveryStreamNoEcho(ParameterNoEchoDefault, CloudFormationLintRule):
